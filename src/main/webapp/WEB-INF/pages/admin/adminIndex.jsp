...
<head>
    <meta charset="utf-8">
    <title>首页 - CodeHouse(Admin)后台管理系统</title>
                    ...
                    <div class="card bg-primary">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0 fa-1-5x">0.00</p>
                            </div>
                ...
                <div class="card bg-danger">
                    <div class="card-body clearfix">
                        <div class="pull-right">
                            ...
                            <p class="h3 text-white m-b-0 fa-1-5x">${userCounts}</p>
                        </div>
                ...
                <div class="card bg-success">
                    <div class="card-body clearfix">
                        <div class="pull-right">
                            ...
                            <p class="h3 text-white m-b-0 fa-1-5x">${moviceCounts}</p>
                        </div>
                ...
                <div class="card bg-purple">
                    <div class="card-body clearfix">
                        <div class="pull-right">
                            ...
                            <p class="h3 text-white m-b-0 fa-1-5x">${commentCounts}</p>
                        </div>
