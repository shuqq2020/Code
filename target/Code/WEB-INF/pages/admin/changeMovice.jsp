...
<head>
    <meta charset="utf-8">
    <title>修改密码 - CodeHouse(Admin)后台管理系统</title>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 后台首页 - 修改密码 </span>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="fileupload" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="mname">视频标题</label>
                                        <input type="text" class="form-control" name="mname" id="mname" value="${movice.mname}" placeholder="请输入视频标题">
                                    </div>
                                    <div class="form-group">
                                        <table>
                                            <tr>
                                    ...
                                    <input type="hidden" name="mid" id="mid" value="${movice.mid}">
                                    <div class="form-group">
                                        <label for="introduction">课程介绍</label>
                                        <input type="text" class="form-control" name="introduction" id="introduction" value="${movice.introduction}" placeholder="输入课程介绍">
                                    </div>
